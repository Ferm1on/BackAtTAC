...
$CivicA = Read-TACData -Path .\CivicAddress_1503.csv -Properties CivicAddress
$CivicA
# Test simple load CSV CivicAddresses with good checksum Validation
$CivicA = Read-TACData -Path .\CivicAddress_1503.csv -Properties CivicAddress -Checksum $CivicASum
...
$CivicA = Read-TACData -Path .\CivicAddress_1503.csv -Properties CivicAddress -Checksum $CivicASum -Verbose
# Test Bad checksum
...
$CivicB = Read-TACData -Path .\CivicAddress_1503.xml -Properties CivicAddress
$CivicB
# Test simple load XML CivicAddresses with good checksum Validation
$CivicB = Read-TACData -Path .\CivicAddress_1503.xml -Properties CivicAddress -Checksum $CivicBSum
# Test verbose proper propagation.
$CivicB = Read-TACData -Path .\CivicAddress_1503.xml -Propertties CivicAddress -Verbose
# Test verbose with good checksum
$CivicB = Read-TACData -Path .\CivicAddress_1503.xml -Properties CivicAddress -Checksum $CivicBSum -Verbose
# Test Bad checksum
$CivicBSum = (Get-FileHash -PAth .\CivicAddress_1503.xml -Algorithm SHA256).Hash
$CivicB = Read-TACData -Path .\CivicAddress_1503.csv -Properties CivicAddress -Checksum $CivicBSum
$CivicB = Read-TACData -Path .\CivicAddress_1503.csv -Properties CivicAddress -Checksum $CivicBSum -Verbose
...
$LocationA = Read-TACData -Path .\LocationSchema_1503.csv -Properties LocationSchema
$LocationA

# Test simple load CSV Subnet file.
$SubnetA = Read-TACData -Path .\Subnet_1503.csv -Properties Subnet
$SubnetA

# Test simple load CSV Switch file.
$SwitchA = Read-TACData -Path .\Switch_1503.csv -Properties Switch
$SwitchA

# Test simple load CSV WAP file.
$WAPA = Read-TACData -Path .\WaP_1503.csv -Properties WAP
$WAPA
